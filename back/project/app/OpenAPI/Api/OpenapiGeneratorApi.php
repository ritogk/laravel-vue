...
/**
 * OpenapiGeneratorApi Class Doc Comment
 *
 * @category Class
 * @package  App\OpenAPI
 * @author   OpenAPI Generator team
...
class OpenapiGeneratorApi
{
    ...
    /**
     * Operation openapiGeneratorPost
     *
     ...
     */
    public function openapiGeneratorPost($requestFile = null)
    {
        list($response) = $this->openapiGeneratorPostWithHttpInfo($requestFile);
        return $response;
    }

    /**
     * Operation openapiGeneratorPostWithHttpInfo
     *
     * multipart/form-dataだとリクエストボディの型が生成されないので型を生成するためだけのAPI
     *
     ...
     */
    public function openapiGeneratorPostWithHttpInfo($requestFile = null)
    {
        $request = $this->openapiGeneratorPostRequest($requestFile);
    ...
    /**
     * Operation openapiGeneratorPostAsync
     *
     * multipart/form-dataだとリクエストボディの型が生成されないので型を生成するためだけのAPI
     *
     * @param  \App\OpenAPI\Model\RequestFile $requestFile (optional)
     ...
     */
    public function openapiGeneratorPostAsync($requestFile = null)
    {
        return $this->openapiGeneratorPostAsyncWithHttpInfo($requestFile)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation openapiGeneratorPostAsyncWithHttpInfo
     *
     * multipart/form-dataだとリクエストボディの型が生成されないので型を生成するためだけのAPI
     *
     * @param  \App\OpenAPI\Model\RequestFile $requestFile (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function openapiGeneratorPostAsyncWithHttpInfo($requestFile = null)
    {
        $returnType = '\App\OpenAPI\Model\FilePath';
        $request = $this->openapiGeneratorPostRequest($requestFile);
    ...
    /**
     * Create request for operation 'openapiGeneratorPost'
     *
     * @param  \App\OpenAPI\Model\RequestFile $requestFile (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function openapiGeneratorPostRequest($requestFile = null)
    {

        $resourcePath = '/openapi-generator';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
